  ...
  ru: {
    ...
    bullets: [
      ...
      },
      {
        ...
        text: 'Корректная архитектура доверия прямо показывает, что именно делается, что не обещается и где рекомендации зависят от исходных данных проекта.',
      },
    ],
    linksTitle: 'Следующие страницы доверия',
  },
  en: {
    chip: 'About',
  ...
  ru: {
    ...
    bullets: [
      ...
      },
      {
        ...
        text: 'Берутся в расчет требования классической выдачи, сниппетной конкуренции, готовности к цитированию и фактической ясности для AI-ответов.',
      },
    ],
    linksTitle: 'Связанные страницы доверия',
  },
  en: {
    chip: 'Methodology',
...
const editorialPolicyPageCopy: Record<Locale, TrustPageCopy> = {
  ru: {
    ...
    cardsTitle: 'Что должен закрывать сильный редакционный слой',
    cards: [
      {
      ...
      },
      {
        ...
        text: 'Статьи должны показывать дату публикации и дату обновления, если подход существенно меняется из-за алгоритмов, интерфейсов поиска или смены рабочего процесса.',
      },
      {
    ...
    bullets: [
      {
        ...
        text: 'Когда статья показывает, как вывод связан с подходом и реальной практикой, она лучше работает и на доверие, и на потенциал для цитирования.',
      },
      {
