  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-[#07111f]/78 backdrop-blur-xl">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between border-b border-white/5 py-3 text-xs text-slate-300">
          ...
          <div className="hidden items-center gap-3 md:flex">
            {socialLinks.telegram && (
              <a
                ...
                className="rounded-full border border-white/10 p-2 transition hover:border-cyan-300/50 hover:text-cyan-200"
                aria-label="Telegram"
              >
