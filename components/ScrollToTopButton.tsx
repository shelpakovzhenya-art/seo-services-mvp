...
export default function ScrollToTopButton() {
  ...
  return (
    ...
    >
      <span className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/14 bg-white/10 text-cyan-200 shadow-[inset_0_1px_0_rgba(255,255,255,0.12)]">
