    ...
    if priority_pages and (commercial_gap_ratio >= 0.45 or trust_gap_ratio >= 0.55):
        ...
        issues.append(
            AuditIssue(
                ...
                why_it_matters=(
                    "Коммерческий интент закрывается не общим SEO-текстом, а условиями выбора: "
    ...
    if priority_pages and (support_gap_ratio >= 0.5 or thin_priority_ratio >= 0.35):
        ...
        issues.append(
            AuditIssue(
                ...
                why_it_matters=(
                    "Приоритетные страницы лучше усиливать не водой, а новыми абзацами под потерянные запросы, "
    ...
    if priority_pages and (structure_gap_ratio >= 0.35 or breadcrumb_gap_ratio >= 0.45):
        ...
        issues.append(
            AuditIssue(
                ...
                why_it_matters=(
                    "Внутренняя перелинковка должна распределять вес не хаотично, а тематически: "
...
def dynamic_build_roadmap(audit: dict) -> list[tuple[str, list[str]]]:
    ...
    sprint_2 = [
        ...
        "Разобрать ключевые страницы по их роли в структуре: какие оставить, какие переписать, какие объединить, а какие увести в архив.",
    ]
            ...
            "checks": [
                ...
                },
                {
                    ...
                    "findings": [
                        ...
                        "Прирост даёт не наращивание воды, а повторная оптимизация: новые абзацы под потерянные запросы, доказательства, таблицы, кейсы, фото и повторная перелинковка.",
                    ],
