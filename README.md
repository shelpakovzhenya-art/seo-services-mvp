...
7. The admin SEO audit generator relies on the included `nixpacks.toml` and Python requirements, so Railway can install Python plus Chromium for branded PDF/DOCX audits with screenshots.
