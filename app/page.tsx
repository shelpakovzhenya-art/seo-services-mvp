...
const homeCopy: Record<Locale, any> = {
  ru: {
    ...
    approachTitle: 'Где сайт чаще всего теряет заявку и поисковый спрос',
    approachText:
      'Обычно проблема лежит не в одном теге, а в связке: структура, посадочные страницы, коммерческие блоки, доверие и следующий шаг до обращения.',
    advantageCards: [
      { icon: FileText, title: 'Аудит по приоритетам', text: 'Сначала видно, какие шаблоны и страницы реально режут потенциал сайта, а что можно не трогать сейчас.' },
      { icon: LineChart, title: 'Работа на заявку', text: 'Фокус не на формальном списке SEO-действий, а на страницах и решениях, которые влияют на обращения.' },
      { icon: BarChart3, title: 'Каркас под рост', text: 'Структура, контент, техбаза и подача сайта собираются так, чтобы проект можно было усиливать без хаоса.' },
    ],
    ...
    reviewsTitle: 'Что видно по отзывам клиентов',
    ...
    contactText: 'Разберу, что именно мешает росту, на каких страницах теряются заявки и какой первый шаг сейчас выглядит самым уместным.',
    ...
    contactConcreteText: 'В ответе будет гипотеза по первому шагу, а не общие фразы про “рост” и “потенциал”.',
  },
  en: {
    metadata: {
    ...
    approachTitle: 'Where websites usually lose both demand and lead flow',
    approachText: 'The bottleneck is usually not one tag. It tends to sit in the combination of structure, landing pages, commercial blocks, trust, and the next step toward inquiry.',
    advantageCards: [
      { icon: FileText, title: 'Priority-led audits', text: 'The first output shows which templates and pages actually limit the site instead of piling on secondary notes.' },
      { icon: LineChart, title: 'Lead-focused work', text: 'The process is centered on pages and decisions that affect inquiries, not a formal checklist of SEO actions.' },
      { icon: BarChart3, title: 'A structure that scales', text: 'Structure, content, technical foundations, and presentation are assembled so the site can keep growing without chaos.' },
    ],
    ...
    reviewsTitle: 'What client feedback actually reveals',
    ...
    contactText: 'I will show what is blocking growth, which pages are losing leads, and what the most sensible first move looks like right now.',
    ...
    contactConcreteText: 'The reply will contain a first-step hypothesis, not generic language about “growth” and “potential”.',
  },
}
